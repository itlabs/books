...
这本书的正文用 Markdown 写在 `chapters/` 里，通过一个构建脚本转成交互式网页放在 `site/`。
...
- 第 10、11 章（turtle / pygame）和第 12—15 章（AI）的代码需要真实电脑环境或密钥，
...
它会读取 `chapters/*.md` 和 `README.md`，重新生成 `site/` 里的全部网页。
